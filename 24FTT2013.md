...
The prequisite is to use the template system, deploy static assets/files and have custom views.

We already have Laravel pre-created template for us in `resources/views` folder, even editting it counts as "custom". 
